...
```
The graph now has a cleaner appearance and, despite some overlap, the lines are easier to read. I decided to keep the background a basic grey colour as I think it works well with contrasting the different colours, and the grid lines help to better read the Y axis
