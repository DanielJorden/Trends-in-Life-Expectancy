...
required_packages <- c("tidyverse", "here", "ggplot2", "gganimate", "gifski", "kableExtra", "plotly", "xfun", "tinytex") #creates vector with all required packages
...
print(as.data.frame(head(data_final, n = 12)))

#Below is a HTML version for this code, which was not compatible for PDF:
...
#This will allow the interactive plot to be knit into the HTML
if(knitr::is_html_output()){
interactive
}
```
